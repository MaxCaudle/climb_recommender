...
from backend.temporal import load_climbs_from_area_workflow
...
async def main():
    ...
    worker = Worker(
        ...
        workflows=[load_climbs_from_area_workflow.LoadClimbsFromAreaWorkflow],
        activities=[load_climbs_from_area_workflow.get_all_climbs_for_area,
                    load_climbs_from_area_workflow.get_climbs_for_page],
    )
